...
:::tip Please note that hk is included since mise [v2025.2.6](https://github.com/jdx/mise/releases/tag/v2025.2.6), so you might have to `brew upgrade mise` or equivalent to have it available.
